<template>
  <div id="editor">
    <q-btn v-if="!editable" @click="editable = true">Edit</q-btn>
    <span v-else>
      <q-btn @click="openModal">New Node</q-btn>
      <q-btn @click="endEdit">End</q-btn>
    </span>
    <q-btn @click="openInputModal">Import/Export</q-btn>
    <q-btn @click="downloadSVG">Download SVG</q-btn>
    <q-btn @click="isAskClearDiagram = true">Clear Diagram</q-btn>
    <q-btn @click="openSettingsModal">Settings</q-btn>
    <ask-modal :isActive="isAskClearDiagram" @ok="clearDiagram" @cancel="cancel">
